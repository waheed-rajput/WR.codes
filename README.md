...
### 🛒 E-Commerce Website
Full stack shopping website with login and cart system.

### 🤖 AI Chatbot
AI chatbot using OpenAI API and React.

### 🎵 Music Player
Responsive music player with modern UI.
